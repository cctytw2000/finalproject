                                    ...
                                    <form action="RegisteredMember.do" method="post">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="account" name="account" style="display:inline" autocomplete="off"><i style="margin:-15px" id="check" class="fas fa-clipboard-check"></i><span style="margin-left:30px"
                                                    id="account_msg"></span>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="password" class="form-control" id="password" name="password" style="display:inline"><i style="margin:-20px" onclick="showHide();" id="eye" class="fas fa-eye"></i><span style="margin-left:30px"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="username" name="username" style="display:inline"><span id="msg" style="margin:-15px"></span>
                                ...
                                <div class="modal-body">
                                    <form action="LoginMember.do" method="post">
                                        <fieldset>
                                            ...
                                            <div style="width: 90%;margin-left:30px">
                                                <button name="FaceBook" type="button" style="background-color: #0066FF" class="btn btn-facebook" onclick="FBLogin();">
                                            <i class="fab fa-facebook-f fa-lg"></i> Facebook登入
                                        </button>
                                                <button name="Google" type="button" style="background-color: #FF3333" class="btn btn-google" onclick="GoogleLogin();">
                                            ...
                                            <div id="submit" class="modal-footer" style="text-align: center">
                                                <input name="login" class="btn btn-primary" type="submit" value="登入"> <input class="btn btn-secondary" name="fergetpwd" type="submit" value="忘記密碼">
                                            </div>
