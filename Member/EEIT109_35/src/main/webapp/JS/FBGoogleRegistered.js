...
let FB_appID_Restistered = "689357491476626";
...
window.fbAsyncInit = function () {
	FB.init({
		appId: FB_appID_Restistered,//FB appID
...
let Google_appId_Restistered = "894099305493-6e891p90q17r6rf2114i0f8b4gr8f51l.apps.googleusercontent.com";
	...
	gapi.load('client:auth2',
		{
			callback: function () {
				...
				gapi.client.init({
					clientId: Google_appId_Restistered,
